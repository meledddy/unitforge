...
const priceSheetsMessages = {
  en: {
    ...
    listDescription: "Create and manage public price sheets for this workspace.",
    ...
    noMatchingHint: "Search matches title, slug, description, and translated sheet content within this workspace only.",
    ...
    deleteTitle: "Delete",
    deleteDescription: "Delete removes the sheet and its items from this workspace.",
    deleteButton: "Delete Price Sheet",
    leadSingle: "inquiry",
    leadPlural: "inquiries",
    leadVisibilityBadge: "Inquiry intake",
    ...
    draftOnlyDescription: "Draft Price Sheets are private. Inquiries can start arriving only after the sheet is published.",
    hiddenDescription: "The public page is live, but the inquiry form is hidden in the public settings for this sheet.",
    activeDescription: "The public page is published and the inquiry form is active. New submissions will land here.",
    leadsBadge: "Inquiries",
    leadInboxTitle: "Inquiry inbox",
    leadInboxDescription:
      "Submitted inquiries for this Price Sheet live here as an operational area. They stay separate from pricing edits so operators can review demand without digging through the form.",
    leadCountLabel: "Inquiry count",
  ...
  ru: {
    ...
    listDescription: "Создавайте и управляйте публичными прайс-листами для текущего рабочего пространства.",
    ...
    noMatchingHint: "Поиск работает по названию, slug, описанию и переведенному контенту листа только внутри текущего рабочего пространства.",
    ...
    emptyHint: "Листы остаются пустыми, пока вы не добавите реальный контент. Для локальной проверки заранее создаются только bootstrap-оператор и рабочее пространство.",
    itemsCount: "позиций",
    ...
    deleteDescription: "Удаление убирает лист и все его позиции из текущего рабочего пространства.",
    ...
    publicIntake: "Публичный прием заявок",
    draftOnly: "Только черновик",
    receivingInquiries: "Принимает запросы",
    formHidden: "Форма скрыта",
    draftOnlyDescription: "Черновые прайс-листы приватны. Заявки могут поступать только после публикации.",
    hiddenDescription: "Публичная страница работает, но форма запроса скрыта в публичных настройках этого листа.",
    activeDescription: "Публичная страница опубликована, и форма запроса активна. Новые заявки будут попадать сюда.",
    leadsBadge: "Заявки",
    leadInboxTitle: "Входящие заявки",
    leadInboxDescription:
      "Отправленные заявки по этому прайс-листу собраны здесь как отдельная операционная зона. Они остаются отдельно от редактирования цен, чтобы оператор не искал их внутри формы.",
    leadCountLabel: "Количество заявок",
    ...
    hiddenLeadEmpty: "Публичная форма запроса сейчас скрыта. Включите ее в настройках листа, когда захотите собирать заявки.",

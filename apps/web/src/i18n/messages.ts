...
const priceSheetsMessages = {
  en: {
    ...
    stateDescription: "Control page visibility and inquiry intake.",
    ...
    deleteTitle: "Delete",
    deleteDescription: "Delete this sheet and its items from the workspace.",
    ...
    hiddenDescription: "The public page is live, but the inquiry form is hidden in this sheet’s public settings.",
  ...
  ru: {
    ...
    stateDescription: "Управляйте видимостью страницы и приемом заявок.",
    ...
    deleteDescription: "Удалите этот прайс-лист и все его позиции из рабочего пространства.",
    ...
    hiddenDescription: "Публичная страница работает, но форма заявок скрыта в публичных настройках этого прайс-листа.",
    activeDescription: "Публичная страница опубликована, форма заявок активна. Новые заявки будут появляться здесь.",
    leadsBadge: "Заявки",
...
const priceSheetFormMessages = {
  en: {
    ...
    presentationAppearanceDescription: "Controls how customers see this public page.",
    currency: "Currency",
    contactAndCtaTitle: "Public contact and CTA",
    contactAndCtaDescription: "These details appear on the public page. Leave a field blank to hide it.",
    ...
    businessDetailsDescription: "Optional details shown as separate rows on the public page.",
    ...
    translationHint: "Leave these fields blank to keep the primary content.",
    itemsTitle: "Items",
    itemsDescription: "Shared fields stay separate from localized content.",
    addItem: "Add item",
    itemLabel: "Item",
  ...
  ru: {
    ...
    presentationAppearanceDescription: "Определяет, как клиенты увидят публичную страницу.",
    currency: "Валюта",
    contactAndCtaTitle: "Публичные контакты и CTA",
    contactAndCtaDescription: "Эти данные показываются на публичной странице. Оставьте поле пустым, чтобы скрыть блок.",
    ...
    businessDetailsDescription: "Необязательные данные, которые показываются отдельными строками на публичной странице.",
    ...
    translationHint: "Оставьте эти поля пустыми, чтобы использовать основной контент.",
    itemsTitle: "Позиции",
    itemsDescription: "Общие поля отделены от локализованного контента.",

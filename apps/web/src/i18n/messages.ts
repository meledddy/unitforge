...
const priceSheetsMessages = {
  en: {
    ...
    notificationHintDescription:
      "Webhook, email, and Telegram notifications will be configured later. Stored inquiries remain available here.",
  ...
  ru: {
    ...
    notificationHintDescription:
      "Webhook, email и Telegram-уведомления будут настроены позже. Сохраненные заявки остаются доступны здесь.",

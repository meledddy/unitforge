    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm text-muted-foreground">
            <p className="font-medium capitalize text-foreground">{session.subscription?.status ?? messages.settingsPage.unconfigured}</p>
            <p>{messages.settingsPage.plan}: {session.subscription?.plan ?? messages.settingsPage.notAssigned}</p>
            <p>{messages.settingsPage.provider}: {session.subscription?.provider ?? messages.settingsPage.notConfigured}</p>
          </CardContent>
        </Card>
      </div>

      <PlaceholderPanel
        title={messages.settingsPage.stripeTitle}
        description={messages.settingsPage.stripeDescription}
      >
